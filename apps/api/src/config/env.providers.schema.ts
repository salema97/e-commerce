...
export const envProvidersSchema = z.object({
  ...
  MARKETING_PLACEMENT_CACHE_TTL_SECONDS: z.coerce.number().int().min(0).default(90),
  LLM_PROVIDER: z.enum(['console', 'openai', 'anthropic', 'google']).default('console'),
  ...
  PRODUCT_ANALYTICS_PROVIDER: z.enum(['console', 'posthog']).default('console'),
  ...
  ACCOUNTING_PROVIDER: z.enum(['console', 'siigo']).default('console'),
