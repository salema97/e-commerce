...
export const envProvidersSchema = z.object({
  ...
  KUSHKI_PRIVATE_KEY: z.string().min(1).default('dev-kushki-key'),
  KUSHKI_WEBHOOK_SECRET: z.string().min(1).default('dev-kushki-webhook'),
  PAYPHONE_TOKEN: z.string().min(1).default('dev-payphone-token'),
  PAYPHONE_STORE_ID: z.string().min(1).default('dev-store-id'),
  MERCADOPAGO_ACCESS_TOKEN: z.string().min(1).default('dev-mercadopago-token'),
  MERCADOPAGO_WEBHOOK_SECRET: z.string().min(1).default('dev-mercadopago-webhook'),
  PLACETOPAY_LOGIN: z.string().min(1).default('dev-placetopay-login'),
  PLACETOPAY_SECRET_KEY: z.string().min(1).default('dev-placetopay-secret'),
  ...
  SRI_RUC: z.string().min(1).default('0591764479001'),
  SRI_SOL_KEY: z.string().min(1).default('dev-sol-key'),
  SRI_DIGITAL_CERTIFICATE_PATH: z.string().min(1).default('certs/dev-sri.p12'),
  SRI_DIGITAL_CERTIFICATE_PASSWORD: z.string().min(1).default('DevSriCert0591!'),
  ...
  EVOLUTION_API_KEY: z.string().min(1).default('change-me'),
  EVOLUTION_WEBHOOK_SECRET: z.string().min(1).default('e2e-evolution-webhook-secret'),
